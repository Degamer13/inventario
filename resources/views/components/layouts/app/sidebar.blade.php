...
@endcan
                    @can('list responsable')
                        <flux:navlist.item icon="user-group" :href="route('responsables.index')" :current="request()->routeIs('responsables.index')" wire:navigate>
                            {{ __('Responsables') }}
                        </flux:navlist.item>
                    @endcan
