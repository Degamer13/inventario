   ...
   <div class="fixed inset-0 flex items-center justify-center z-50">
        ...
        <div class="rounded shadow-lg p-6 w-full max-w-lg z-10 bg-white dark:bg-neutral-900 text-gray-900 dark:text-gray-100 max-h-[80vh] overflow-y-auto">
            ...
            <div class="space-y-3">
                ...
                <span class="text-red-500 text-sm">Campo requerido</span>
                @enderror
                <label class="block font-medium">Observación  <span class="text-red-500">*</span></label>
                ...
                <span class="text-red-500 text-sm">Campo requerido</span>
                @enderror
                <label class="block font-medium">Placa  <span class="text-red-500">*</span></label>
                ...
                <span class="text-red-500 text-sm">Campo requerido</span>
                @enderror
                <label class="block font-medium">Año  <span class="text-red-500">*</span></label>
                ...
                <span class="text-red-500 text-sm">Campo requerido</span>
                @enderror
                <label class="block font-medium">Batería  <span class="text-red-500">*</span></label>
