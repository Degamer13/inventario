        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
            <thead class="bg-gray-100 dark:bg-neutral-950">
                <tr>
                    ...
                    <th class="px-4 py-2 text-left text-sm font-medium text-gray-600 dark:text-gray-200 uppercase">Unidad</th>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                @forelse($materiales as $m)
                    <tr class="bg-white dark:bg-neutral-900 hover:bg-gray-50 dark:hover:bg-neutral-800">
                        ...
                        <td class="px-4 py-2">{{ $m->unidad_medida }}</td>
...
@endcan
    ...
    <div class="fixed inset-0 flex items-center justify-center z-50">
        ...
        <div class="rounded shadow-lg p-6 w-full max-w-lg z-10 bg-white dark:bg-neutral-900 text-gray-900 dark:text-gray-100 max-h-[80vh] overflow-y-auto">
            <h2 class="text-lg font-bold mb-4">{{ $material_id ? 'Editar Material' : 'Nuevo Material' }}</h2>
            <div class="space-y-3">
                ...
                @error('serial') <span class="text-red-500 text-sm">Campo requerido</span>@enderror
                ...
                @error('marca') <span class="text-red-500 text-sm">Campo requerido</span>
                @enderror
                ...
                @error('cantidad') <span class="text-red-500 text-sm">Campo requerido</span>
                @enderror
                <label class="block font-medium">Unidad de medida  <span class="text-red-500">*</span></label>
                <input type="text" wire:model="unidad_medida" placeholder="Unidad de medida" class="w-full border border-gray-300 dark:border-neutral-700 rounded px-3 py-2 bg-white dark:bg-neutral-800 text-gray-900 dark:text-gray-100">
                @error('unidad_medida') <span class="text-red-500 text-sm">Campo requerido</span>
                @enderror
                ...
                @error('ubicacion') <span class="text-red-500 text-sm">Campo requerido</span>
                @enderror
            </div>
            <div class="mt-4 flex justify-end space-x-2">
                ...
                <button wire:click="{{ $material_id ? 'update' : 'store' }}" class="px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700 dark:hover:bg-indigo-500">Guardar</button>
            </div>
        </div>
    </div>
    @endif
    ...
    <div class="fixed inset-0 flex items-center justify-center z-50">
        ...
        <div class="rounded shadow-lg p-6 w-full max-w-lg z-10 bg-white dark:bg-neutral-900 text-gray-900 dark:text-gray-100">
            <h2 class="text-lg font-bold mb-4">Detalles del Material</h2>
            <div class="space-y-2">
                <p><strong>Descripción:</strong> {{ $descripcion }}</p>
                <p><strong>Marca:</strong> {{ $marca }}</p>
                <p><strong>Serial:</strong> {{ $serial }}</p>
                <p><strong>Cantidad:</strong> {{ $cantidad }}</p>
                <p><strong>Unidad de medida:</strong> {{ $unidad_medida }}</p>
    ...
    <div class="fixed inset-0 flex items-center justify-center z-50">
        ...
        <div class="rounded shadow-lg p-6 w-full max-w-sm z-10 bg-white dark:bg-neutral-900 text-gray-900 dark:text-gray-100">
            <h2 class="text-lg font-bold mb-4">Eliminar Material</h2>
